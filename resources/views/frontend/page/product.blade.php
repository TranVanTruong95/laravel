      ...
      <div class="col-sm-5">
        ...
        <ul class="thumbnails mainimage">
          ...
          <li class="producthtumb">
            <a class="thumbnail" >
              <img  src="{!! asset('resources/upload/detail/'.$image->images) !!}" alt="" title="">
            </a>
          </li>
          @endforeach
        </ul>
          ...
          <div class="span7">
            ...
            <div class="productprice">
              <div class="productpageprice">
                <span class="spiral"></span>${!! number_format($product_detail['price']) !!}</div>
            </div>
    ...
    <ul class="thumbnails">
      <li class="span3">
        ...
        <div class="thumbnail">
          ...
          <a href="#"><img alt="" src="{!!url('public/frontend/img/product1.jpg') !!}"></a>
          <div class="pricetag">
      ...
      <li class="span3">
        <a class="prdocutname" href="product.html">Product Name Here</a>
        <div class="thumbnail">
          <a href="#"><img alt="" src="{!!url('public/frontend/img/product2.jpg') !!}"></a>
          <div class="pricetag">
            <span class="spiral"></span><a href="#" class="productcart">ADD TO CART</a>
            <div class="price">
              <div class="pricenew">$4459.00</div>
